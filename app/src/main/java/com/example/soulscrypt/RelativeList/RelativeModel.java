...
public class RelativeModel {
    ...
    public RelativeModel(String relative_name, String relative_death_date, String relative_section, double latitude, double longitude, int record_id, String relationship) {
